            ...
            <table class="table table-striped table-sm table-hover">
                ...
                @foreach($empleados as $empleado)
                    <tr>
                        ...
                        <td>
                            <div class="mt-1">
                                <a href="/empleados/{{$empleado->idEmpleado}}/editar" class="btn btn-sm btn-outline-warning">Editar</a>
                                <a href="/empleados/{{$empleado->idEmpleado}}/eliminar" class="btn btn-sm btn-outline-danger">Eliminar</a>
                            </div>
                        </td>
                    </tr>
                @endforeach
